...
public class CustomeListVoice extends LinearLayout {
    ...
    public CustomeListVoice(Context context) {
        super(context);
        init(context);
    }

    public CustomeListVoice(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public CustomeListVoice(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        View view = inflater.inflate(R.layout.custome_listvoice, this, true);
